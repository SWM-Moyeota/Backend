...
class FcmCallNotifierTest {
    ...
    private static final PartySummary 강남출발방 =
            new PartySummary(1L, 37.4979, 127.0276, 37.3948, 127.1112, "강남역", "판교역", 2, 12000, 25, null);
    ...
    private static final DriverAccess 토큰없음 = new DriverAccess() {
        ...
        @Override
        public java.util.Optional<Long> findUserId(Long driverId) { return java.util.Optional.empty(); }
    };
