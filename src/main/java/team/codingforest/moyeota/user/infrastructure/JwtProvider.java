...
import team.codingforest.moyeota.user.domain.enums.Token;
...
public class JwtProvider {
    ...
    private final Map<Token, Duration> validities;
    ...
    public JwtProvider(@Value("${jwt.secret}") String secret,
        ...
        this.validities = new EnumMap<>(Map.of(Token.ACCESS, accessValidity, Token.REFRESH, refreshValidity));
    }

    public String issue(UUID publicId, Token type) {
    ...
    public UUID parse(String token, Token expectedType) {
    ...
    public boolean isValid(String token, Token expectedType) {
        try {
